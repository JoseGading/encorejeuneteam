  ...
  return (
    <div className="space-y-8">
      ...
      <div className={`${currentTheme.card} rounded-2xl shadow-md border-2 p-6`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-gradient-to-r from-blue-700 to-blue-500 p-3 rounded-xl">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-blue-700 to-blue-500 text-white hover:from-blue-600 hover:to-blue-500 transition-all shadow-md text-sm font-medium hover:scale-[1.01] active:scale-[0.99]"
          >
            <LogOut size={16} />
            Logout Admin
          </button>
              ...
              {editingEmployee && editingEmployee.id === emp.id ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-blue-700 to-blue-500 text-white hover:from-blue-600 hover:to-blue-500 transition-all text-sm font-medium hover:scale-[1.01] active:scale-[0.99]"
                    >
                      <Save size={16} />
                      Simpan
                    </button>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-lg bg-gradient-to-r from-blue-700 to-blue-500 text-white hover:from-blue-600 hover:to-blue-500 transition-all text-sm font-medium hover:scale-[1.01] active:scale-[0.99]"
                  >
                    <Edit size={16} />
                    Edit
                  </button>
      ...
      <div className={`${currentTheme.card} rounded-2xl shadow-md border-2 p-6`}>
        ...
        <div className="mb-6 p-4 bg-blue-950/20 border border-blue-500/15 rounded-xl">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className={`${currentTheme.badge} rounded-xl p-5 border-2`}>
            <div className="flex items-center gap-2 mb-4">
              <div className="bg-gradient-to-r from-blue-700 to-blue-500 p-2 rounded-lg">
            ...
            <div className="mb-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-2 rounded-lg bg-gradient-to-r from-blue-700 to-blue-500 text-white hover:from-blue-600 hover:to-blue-500 transition-all text-sm font-medium hover:scale-[1.01] active:scale-[0.99]"
                >
                  <Plus size={16} />
                  Tambah
                </button>
      ...
      <div className={`${currentTheme.card} rounded-2xl shadow-md border-2 p-6`}>
        ...
        <div className="grid grid-cols-3 gap-4">
          <button
            onClick={exportData}
            className="flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-gradient-to-r from-blue-700 to-blue-500 text-white hover:from-blue-600 hover:to-blue-500 transition-all shadow-md font-medium hover:scale-[1.01] active:scale-[0.99]"
          >
            <Upload size={18} />
            Export Data
          </button>
          
          <label className="flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-gradient-to-r from-blue-700 to-blue-500 text-white hover:from-blue-600 hover:to-blue-500 transition-all shadow-md font-medium cursor-pointer hover:scale-[1.01] active:scale-[0.99]">
            <Upload size={18} />
            Import Data
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-blue-950/40 text-blue-200 hover:bg-blue-900/40 transition-all shadow-md font-medium border border-blue-500/15 hover:scale-[1.01] active:scale-[0.99]"
          >
            <Trash2 size={18} />
            Clear All Data
          </button>
