    ...
    <div className="space-y-8">
      ...
      <div className={`${currentTheme.card} rounded-2xl shadow-md border-2 p-6`}>
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-red-500 to-pink-500 text-white hover:from-red-600 hover:to-pink-600 transition-all shadow-md text-sm font-medium"
          >
            <LogOut size={16} />
            Logout Admin
          </button>
      ...
      <div className={`${currentTheme.card} rounded-2xl shadow-md border-2 p-6`}>
        ...
        <div className="space-y-4">
          {employees.map(emp => (
            <div key={emp.id} className={`${currentTheme.badge} rounded-xl p-5 border-2`}>
              {editingEmployee && editingEmployee.id === emp.id ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-emerald-500 to-teal-500 text-white hover:from-emerald-600 hover:to-teal-600 transition-all text-sm font-medium"
                    >
                      <Save size={16} />
                      Simpan
                    </button>
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg ${currentTheme.badge} hover:opacity-80 transition-all text-sm font-medium`}
                    >
                      Batal
                    </button>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-lg bg-gradient-to-r from-blue-500 to-indigo-500 text-white hover:from-blue-600 hover:to-indigo-600 transition-all text-sm font-medium"
                  >
                    <Edit size={16} />
                    Edit
                  </button>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 max-h-40 overflow-y-auto">
                      {emp.cleaningTasks.map(task => (
                        <div key={task.id} className="flex items-center justify-between bg-white/50 rounded p-2 text-xs">
                      ...
                      <div key={day} className="relative">
                        {hasData ? (
                          hasOvertime ? (
                            ...
                            <button
                              onClick={() => handleEditCalendar(emp.name, currentMonth, day, currentYear)}
                              className={`w-full calendar-cell ${statusConfig[data.status].bg} rounded-lg p-2.5 text-center text-white text-xs font-medium hover:scale-105 transition-transform cursor-pointer shadow-sm`}
                          ...
                          <button
                            onClick={() => handleEditCalendar(emp.name, currentMonth, day, currentYear)}
                            className={`w-full calendar-cell ${currentTheme.badge} rounded-lg p-2.5 text-center text-xs font-medium border border-dashed border-slate-300 hover:scale-105 transition-transform cursor-pointer`}
            ...
            <div key={emp.id} className={`${currentTheme.badge} rounded-xl p-5 border-2`}>
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-lg bg-gradient-to-r from-orange-500 to-red-500 text-white hover:from-orange-600 hover:to-red-600 transition-all text-sm font-medium"
                >
                  <Trash2 size={14} />
                  Reset Data
                </button>
                      ...
                      <div key={task.id} className="flex items-center justify-between bg-white/50 rounded p-2 text-xs">
                        <div className="flex-1">
                          ...
                          {task.completed && task.duration && (
                            <p className="text-xs text-emerald-600">✓ {task.duration}</p>
                          )}
                        </div>
                        <button
                          onClick={() => handleDeleteTask(emp.id, 'cleaning', task.id)}
      ...
      <div className={`${currentTheme.card} rounded-2xl shadow-md border-2 p-6`}>
        ...
        <div className="grid grid-cols-2 gap-6">
          {/* Shift Pagi */}
          <div className={`${currentTheme.badge} rounded-xl p-5 border-2`}>
            ...
            <div className="mb-4">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className={`flex-1 px-3 py-2 rounded-lg border ${currentTheme.input} text-sm`}
                  onKeyPress={(e) => {
                    if (e.key === 'Enter') {
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-2 rounded-lg bg-gradient-to-r from-orange-500 to-amber-500 text-white hover:from-orange-600 hover:to-amber-600 transition-all text-sm font-medium"
                >
                  <Plus size={16} />
                  Tambah
                </button>
            ...
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {shiftTasks.pagi.map((task, index) => (
                <div key={index} className="flex items-start justify-between bg-white/50 rounded-lg p-3 text-sm border border-orange-200">
                  <div className="flex-1 flex items-start gap-2">
                    <span className="text-orange-600 font-bold text-xs mt-0.5">{index + 1}.</span>
          ...
          <div className={`${currentTheme.badge} rounded-xl p-5 border-2`}>
            ...
            <div className="mb-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-2 rounded-lg bg-gradient-to-r from-blue-500 to-indigo-500 text-white hover:from-blue-600 hover:to-indigo-600 transition-all text-sm font-medium"
                >
                  <Plus size={16} />
                  Tambah
                </button>
            ...
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {shiftTasks.malam.map((task, index) => (
                <div key={index} className="flex items-start justify-between bg-white/50 rounded-lg p-3 text-sm border border-blue-200">
                  <div className="flex-1 flex items-start gap-2">
                    <span className="text-blue-600 font-bold text-xs mt-0.5">{index + 1}.</span>
                    <p className={currentTheme.text}>{task}</p>
                  </div>
                  <button
              ...
              <div key={emp.id} className={`${currentTheme.badge} rounded-xl p-4 border-2`}>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-emerald-600">{monthStats.hadir}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className={currentTheme.subtext}>Telat:</span>
                    <span className="font-semibold text-rose-600">{monthStats.telat} ({monthStats.totalLateHours}h)</span>
                  </div>
                  <div className="flex justify-between">
                    <span className={currentTheme.subtext}>Lembur:</span>
                    <span className="font-semibold text-amber-600">{monthStats.lembur}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className={currentTheme.subtext}>Libur:</span>
                    <span className="font-semibold text-blue-600">{monthStats.libur}</span>
                  </div>
                </div>
              </div>
            );
      ...
      <div className={`${currentTheme.card} rounded-2xl shadow-md border-2 p-6`}>
        ...
        <div className="grid grid-cols-3 gap-4">
          <button
            onClick={exportData}
            className="flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-gradient-to-r from-blue-500 to-indigo-500 text-white hover:from-blue-600 hover:to-indigo-600 transition-all shadow-md font-medium"
          >
            <Upload size={18} />
            Export Data
          </button>
          
          <label className="flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-gradient-to-r from-emerald-500 to-teal-500 text-white hover:from-emerald-600 hover:to-teal-600 transition-all shadow-md font-medium cursor-pointer">
            <Upload size={18} />
            Import Data
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-gradient-to-r from-red-500 to-pink-500 text-white hover:from-red-600 hover:to-pink-600 transition-all shadow-md font-medium"
          >
            <Trash2 size={18} />
            Clear All Data
          </button>
