          ...
          [list]: e[list].map(t => {
            if (t.id === taskId) {
              ...
              if (nowCompleted) {
                ...
                logAction('Selesaikan Task', `${e.name} - ${t.task}`);
              }
        ...
        <nav className={`${currentTheme.nav} rounded-2xl shadow-md border-2 p-2 mb-8`}>
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              ...
              <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-gradient-to-r from-blue-700 to-blue-500 text-white shadow-md text-xs font-medium">
              ...
              {!isAdmin && (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-xl bg-gradient-to-r from-blue-700 to-blue-500 text-white hover:from-blue-600 hover:to-blue-500 transition-all shadow-md text-xs font-medium"
                  title="Admin Login"
                >
                  <Lock size={14} />
                  Admin
              ...
              {/* Theme Buttons */}
              <div className={`flex items-center gap-1 p-1 rounded-2xl border border-white/10 ${currentTheme.badge}`}>
              {Object.keys(APP_THEMES).filter(t => !APP_THEMES[t]?.hidden).map(t => {
                ...
                return (
                  <button
                    key={t}
                    onClick={() => setTheme(t)}
                    className={`w-9 h-9 flex items-center justify-center rounded-xl transition-all ${theme === t ? APP_THEMES[t].navActive : `${currentTheme.badge} ${currentTheme.navInactive}`} hover:scale-[1.02] active:scale-[0.98]`}
            ...
            {notifications.map(notif => (
              <div
                ...
                className={`${currentTheme.card} rounded-xl shadow-lg border-2 p-4 animate-slide-in-right ${
                  notif.type === 'urgent' ? 'border-blue-500' :
                  'border-blue-400/60'
                }`}
              >
                <div className="flex items-start gap-3">
                  <div className="p-2 rounded-lg bg-blue-950/40 border border-blue-500/15">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 backdrop-blur-sm">
            <div className={`${currentTheme.card} rounded-3xl shadow-2xl border-2 p-8 max-w-2xl w-full mx-4 relative`}>
              ...
              <div className="text-center mb-6">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-700 to-blue-500 rounded-full mb-4">
                  ...
                  <button
                    ...
                    className={`relative p-6 rounded-2xl border-2 transition-all ${
                      emp.checkedIn || isProcessing
                        ? 'bg-blue-950/30 border-blue-500/25 cursor-not-allowed opacity-70'
                        : 'bg-slate-950/30 border-white/10 hover:border-blue-500/35 hover:shadow-xl hover:scale-105 cursor-pointer'
                    }`}
                  >
                    <div className="flex flex-col items-center gap-3">
                      <div className={`w-16 h-16 rounded-full flex items-center justify-center font-bold text-2xl shadow-lg ${
                        emp.checkedIn
                          ...
                          : 'bg-gradient-to-br from-blue-700 to-blue-500 text-white border-2 border-white/30'
                      }`}>
                      ...
                      <div className="text-center">
                        ...
                        {emp.checkedIn && (
                          <>
                            <p className="text-xs text-blue-200 font-semibold mt-1">✓ Checked In</p>
              ...
              <div className="flex gap-3">
                {checkedInEmployees.length > 0 && (
                  <button
                    onClick={() => setShowCheckInModal(false)}
                    className="flex-1 py-3 rounded-xl bg-gradient-to-r from-blue-700 to-blue-500 text-white font-bold hover:from-blue-600 hover:to-blue-500 transition-all shadow-lg hover:scale-[1.01] active:scale-[0.99]"
                  >
            ...
            <div className={`${currentTheme.card} rounded-2xl shadow-2xl border-2 p-6 max-w-md w-full mx-4`}>
              <div className="flex items-center gap-3 mb-4">
                <div className="bg-blue-950/20 p-3 rounded-xl border border-blue-500/15">
                  <Pause className="text-blue-300" size={24} />
                </div>
                <div>
        ...
        {izinModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className={`${currentTheme.card} rounded-2xl shadow-2xl border-2 p-6 max-w-md w-full mx-4`}>
              <div className="flex items-center gap-3 mb-4">
                <div className="bg-blue-950/20 p-3 rounded-xl border border-blue-500/15">
                  <Bell className="text-blue-300" size={24} />
                </div>
                <div>
              ...
              <div className="flex gap-3 mt-4">
                ...
                <button
                  ...
                  className={`flex-1 px-4 py-2 rounded-lg bg-gradient-to-r from-blue-700 to-blue-500 text-white transition-all text-sm font-medium shadow-md ${
                    isProcessing ? 'opacity-50 cursor-not-allowed' : 'hover:from-blue-600 hover:to-blue-500 hover:scale-[1.01] active:scale-[0.99]'
                  }`}
                >
